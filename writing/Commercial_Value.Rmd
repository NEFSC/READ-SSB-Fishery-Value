...
```{r extract_data, eval=FALSE, include=TRUE}
...
```{r process_deflators, include=FALSE, eval=FALSE}
...
saveRDS(Commercial_Value, file=here("data_folder","main",glue("Commercial_Value_{vintage_string}.Rds")))

write.csv(x = Commercial_Value, file=here("data_folder","main",glue("Commercial_Value_{vintage_string}.csv")))
