...
Gross revenues were extracted from CAMS and aggregated to the stockarea. We do some minor datacleaning by aggregating the cams stock areas to their stock assessment counterparts.  The definition of a 'stock' is pulled from stockeff for the species in there. For others, we used the stock assessment and relevant fishery management documents.
